...
module.exports = {
    async run(bot, message, args) {
        if (message.author.id !== "577715569441243136" && message.author.id !== "574257035894456320" && message.author.id !== "428595127079010304") return message.channel.send("**Unauthorised.**");
